					...
					<div class="collapse navbar-collapse" id="navbarNav">
						<ul class="navbar-nav">
							<li class="d-block d-lg-none">
								<div class="logo">
									<a href="index.html">
										<img src="{{url('assets')}}/images/logo/vCamp_01.png" alt="" width="127">
									</a>
								</div>
							</li>
							...
							<ul class="style-none cart-product-list">
								<li class="d-flex align-items-center selected-item">
									<a href="#" class="item-img d-flex align-items-center justify-content-center">
										<img src="{{url('assets')}}/images/shop/img_18.png" alt="">
									</a>
									<div class="item-info">
								...
								<li class="d-flex align-items-center selected-item">
									<a href="#" class="item-img d-flex align-items-center justify-content-center">
										<img src="{{url('assets')}}/images/shop/img_19.png" alt="">
									</a>
									<div class="item-info">
		...
		<div class="container">
			<div class="row">
				<div class="col-xl-3 col-lg-2 mb-40">
					<div class="logo"><a href="index.html"><img src="{{url('assets')}}/images/logo/vCamp_01.png" alt="" width="127"></a></div>
				</div>
