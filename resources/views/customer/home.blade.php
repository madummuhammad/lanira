		...
		<div class="product_slider_one product_slider_space" id="product_slider_one">
			...
			<div class="item">
				<div class="product-block-one">
					<a href="{{url('product')}}/{{$product->id}}" class="d-flex align-items-center justify-content-center h-100"><img src="{{url('image/product')}}/{{$product->photo}}" alt="" class="product-img tran4s">
					</a>
...
<div class="product-section-one mt-180 lg-mt-100">
	...
	<div class="box-layout mt-90 lg-mt-40">
		<div class="product_slider_one product_slider_space" id="product_slider_custom_1">
			...
			<div class="item">
				<div class="product-block-one">
					<a href="{{url('product')}}/{{$product->id}}" class="d-flex align-items-center justify-content-center h-100"><img src="{{url('image/product')}}/{{$product->photo}}" alt="" class="product-img tran4s"></a>
					<a href="{{url('product')}}/{{$product->id}}" class="category-tag">{{$product->name}}</a>
				</div>
			</div>
			@endforeach
