			...
			<div class="user-data-page clearfix d-md-flex">
				...
				<div class="form-wrapper">
					<form action="<?php echo e(url('login')); ?>" class="user-data-form mt-50 lg-mt-50" method="POST">
...
<?php echo $__env->make('customer.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8.1\htdocs\laniralaravel\resources\views/customer/login.blade.php ENDPATH**/ ?>